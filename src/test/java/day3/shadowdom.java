...
public class shadowdom {
	...
	public static void main(String[] args) throws Exception {
		...
		//finding the first shadow DOM element
		...
		Thread.sleep(1000);
		String textvalue=shadow2.findElement(By.cssSelector("#multi-nested-shadow-element")).getText();
